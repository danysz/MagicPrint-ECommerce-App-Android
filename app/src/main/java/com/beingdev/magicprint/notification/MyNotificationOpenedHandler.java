  ...
  public void notificationOpened(OSNotificationOpenResult result) {
    ...
    if (data != null) {
      ...
      if (activityToBeOpened != null && activityToBeOpened.equals("NotificationActivity")) {
        ...
        Intent intent = new Intent(CustomApplication.APP_CONTEXT, NotificationActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT | Intent.FLAG_ACTIVITY_NEW_TASK);
        CustomApplication.APP_CONTEXT.startActivity(intent);
      } else if (activityToBeOpened != null && activityToBeOpened.equals("MainActivity")) {
        Log.i("OneSignalExample", "customkey set with value: " + activityToBeOpened);
        Intent intent = new Intent(CustomApplication.APP_CONTEXT, MainActivity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT | Intent.FLAG_ACTIVITY_NEW_TASK);
        CustomApplication.APP_CONTEXT.startActivity(intent);
      } else {
        Intent intent = new Intent(CustomApplication.APP_CONTEXT, MainActivity.class);
    ...
    if (actionType == OSNotificationAction.ActionType.ActionTaken) {
      ...
      if (result.action.actionID.equals("ActionOne")) {
        Toast.makeText(CustomApplication.APP_CONTEXT, "ActionOne Button was pressed", Toast.LENGTH_LONG).show();
      } else if (result.action.actionID.equals("ActionTwo")) {
        Toast.makeText(CustomApplication.APP_CONTEXT, "ActionTwo Button was pressed", Toast.LENGTH_LONG).show();
      }
    }
  }
}
